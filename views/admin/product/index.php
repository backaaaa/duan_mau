    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="80">
                ...
                <img src="./uploads/products/<?= htmlspecialchars($p['anh_dai_dien']) ?>" alt="" class="img-fluid">
                <?php endif; ?>
            </td>
            <td>
            ...
            <td>
                <!-- Nút sửa: mở modal riêng cho từng sản phẩm -->
                <button type="button"
                ...
                <!-- Nút xóa: gửi form POST theo id -->
                <form action="index.php?admin=1&page=product&action=delete"
                    method="post"
                    class="d-inline">
...
<div class="modal fade" id="editProduct<?= $p['id'] ?>" tabindex="-1">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <form class="modal-content" action="index.php?admin=1&page=product&action=update" method="post"
            ...
            <div class="modal-header">
                <h5 class="modal-title">Sửa sản phẩm:
                    <?= htmlspecialchars($p['ten_san_pham']) ?>
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="ten_san_pham" value="<?= $p['ten_san_pham'] ?>"
                            required>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <?php if (!empty($p['anh_dai_dien'])): ?>
                        <img src="./uploads/products/<?= htmlspecialchars($p['anh_dai_dien']) ?>" alt="Ảnh hiện tại"
                            class="img-thumbnail mt-1" style="max-height: 120px;">
                        <?php else: ?>
                ...
                <div id="variant-wrapper-<?= $p['id'] ?>">
                    ...
                    <div class="variant-item border rounded p-3 mb-3">
                        <div class="row mb-2 align-items-center">
                            ...
                            <div class="col-md-4">
                                <label>Ảnh màu (nếu đổi)</label>
                                <input type="file" name="anh_mau[]" class="form-control">
                            </div>

                            <div class="col-md-4">
                                <label class="d-block">Ảnh hiện tại</label>

                                <?php if (!empty($v['anh_mau'])): ?>
                                <img src="./uploads/variants/<?= $v['anh_mau'] ?>" class="img-thumbnail"
                                ...
                                <input type="hidden" name="anh_mau_cu[]" value="<?= $v['anh_mau']; ?>">
                            </div>
                        </div>
                        <div class="row mb-2">
                            <div class="col-md-3">
                                <label>Màu</label>
                                <input type="text" class="form-control" name="mau_sac[]" value="<?= $mau ?>" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-2">
                            <div class="col-md-3">
                                <label>Size S</label>
                                <input type="number" name="so_luong_s[]" class="form-control"
                                    value="<?= $sizes['S'] ?? 0 ?>" required>
                            </div>

                            <div class="col-md-3">
                                <label>Size M</label>
                                <input type="number" name="so_luong_m[]" class="form-control"
                                    value="<?= $sizes['M'] ?? 0 ?>" required>
                            </div>

                            <div class="col-md-3">
                                <label>Size L</label>
                                <input type="number" name="so_luong_l[]" class="form-control"
                                    value="<?= $sizes['L'] ?? 0 ?>" required>
                            </div>

                            <div class="col-md-3">
                                <label>Size XL</label>
                                <input type="number" name="so_luong_xl[]" class="form-control"
...
<div class="modal fade" id="deleteProduct<?= $p['id'] ?>" tabindex="-1">
    <div class="modal-dialog">
        <form class="modal-content" action="index.php?admin=1&page=product&action=delete" method="post">
            <input type="hidden" name="id" value="<?= $p['id'] ?>">
            <div class="modal-header">
